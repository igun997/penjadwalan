    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{route("master.dosen.add")}}" class="btn btn-success ml-2 mb-4">
                    ...
                    <a href="{{route("template.dosen")}}" class="btn btn-primary ml-2 mb-4">
                        <li class="fa fa-download"></li> Template Excel
                    </a>
                    <div class="table-responsive">
                        <table id="dosen" class="table table-bordered">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>NIP</th>
                            ...
                            <tbody>
                                @foreach($data as $num => $row)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route("master.dosen.update",$row->id)}}" class="btn btn-warning m-2">
                                                <li class="fa fa-edit"></li>
                                            </a>

                                            <a href="{{route("master.dosen.delete",$row->id)}}" class="btn btn-danger m-2">
        ...
        $(document).ready(function () {
            ...
            $("#import").on("click",function () {
                ...
                dialog.init(function(){
                    setTimeout(function(){
                        var form = [
                            "<form action='{{route("master.dosen.add.action")}}' method='post' enctype='multipart/form-data'>",
